	...
	*/
	...
	me.onNodeClick = function(node) {
        ...
        if(node.children.length == 0){
            $('.ya-seed-elnas').val(node.pk);
            document.getElementById('community-id').innerHTML = node.label;
            document.getElementById('community-desc').innerHTML = node.description;
        }

        else{
            document.getElementById('community-id').innerHTML = "PickUp Community to Join:";
            document.getElementById('community-desc').innerHTML = " ";
        }
